...
import numpy as np
from tokenize_mecab import morphs
import argparse
...
class CBoWModel(object):
    ...
    def __init__(self, train_fname, embedding_fname, model_fname, embedding_corpus_fname,
                 embedding_method="word2vec", is_weighted=True, average=False, dim=100):
        # configurations
        ...
        if is_weighted:
            ...
            self.embeddings = self.load_or_construct_weighted_embedding(embedding_fname, embedding_method,
    ...
    def evaluate(self, test_data_fname, batch_size=3000, verbose=False):
        ...
        print("# of correct:", str(eval_score), ", total:", str(len(test_data)), ", score:",
              str(eval_score / len(test_data)))
